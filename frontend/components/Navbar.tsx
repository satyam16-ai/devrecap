...
export default function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className="fixed top-0 left-0 right-0 z-50 flex flex-col bg-slate-950/80 backdrop-blur-md border-b border-slate-800"
        >
            {/* Launch Offer Banner */}
            <div className="w-full bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 text-black font-black text-xs md:text-sm py-2 text-center shadow-lg relative z-50">
                <span className="tracking-wide">
                    🚀 LAUNCH OFFER: Get Premium for just <span className="bg-black/10 px-1 rounded mx-1">₹10</span> (was <span className="line-through opacity-60 decoration-black/60">₹49</span>)! Limited time only.
                </span>
            </div>
